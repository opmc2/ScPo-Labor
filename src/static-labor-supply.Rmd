...
full_cross_section <- function(lb, N, rho, X){
  #parameters
  p  = list(eta=-1.5,gamma = 0.8,beta=1,beta0=0.1) # define preferences
...
simdata2 <- rbind(full_cross_section(1,10000,1,rnorm(10000)), full_cross_section(1.5,10000,.8,rnorm(10000)))
